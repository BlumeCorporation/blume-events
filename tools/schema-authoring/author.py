...
E("traffic", "signal-phase-changed", "operational", False, False,
  ...
  {"asset_ref": {"class": "signal", "id": "A41-0271", "tenant": "mcr"},
   "intersection_id": "A41-0271", "approach": "NB", "phase_from": "green", "phase_to": "amber",
   "dwell_ms": 42000, "actuated": True,
   "provenance": {"producer": "signal-broker/1.0.0", "node": "site-mcr-north-02",
...
E("traffic", "detector-demand-reported", "operational", False, False,
  ...
  {"asset_ref": {"class": "controller", "id": "A41-0271", "tenant": "mcr"},
...
E("traffic", "incident-declared", "operational", False, False,
  ...
  {"incident_id": "INC-2026-09-07-0114", "kind": "collision", "severity": "high",
   ...
   "provenance": {"producer": "signal-broker/1.0.0", "node": "core-mcr-01",
                  "observed_at": "2026-09-07T14:05:02.480Z"}},
  {"incident_id": "INC-2026-09-07-0114", "kind": "collision", "severity": "high",
   "geo": {"lat": 53.6097, "lon": -2.1561, "accuracy_m": 4.5, "cell": "MCR-0742-19"},
   "asset_ref": {"class": "signal", "id": "A41-0271", "tenant": "mcr"},
...
E("telemetry", "meter-read-recorded", "operational", False, False,
  ...
  {"asset_ref": {"class": "meter", "id": "M-88213-4", "tenant": "mcr"},
   "utility": "electricity", "reading": 148203.412, "unit": "kWh", "interval_s": 1800,
   "quality": "measured",
   "provenance": {"producer": "utility-telemetry/1.0.0", "node": "site-mcr-east-01",
...
E("telemetry", "substation-load-sampled", "operational", False, False,
  ...
  "substation", "SS-MCR-0742", "asset:substation:SS-MCR-0742",
  {"asset_ref": {"class": "substation", "id": "SS-MCR-0742", "tenant": "mcr"},
...
E("telemetry", "pressure-sampled", "operational", False, False,
  ...
  "gateway", "GW-MCR-E-14", "asset:gateway:GW-MCR-E-14",
  {"asset_ref": {"class": "gateway", "id": "GW-MCR-E-14", "tenant": "mcr"},
  ...
  {"asset_ref": {"class": "gateway", "id": "GW-MCR-E-14", "tenant": "mcr"},
   ...
   "geo": {"lat": 53.6104, "lon": -2.1588, "accuracy_m": 8.0, "cell": "MCR-0742-19"},
   "provenance": {"producer": "utility-telemetry/1.0.0", "node": "site-mcr-east-01",
...
E("telemetry", "outage-declared", "operational", False, False,
  ...
  "substation", "SS-MCR-0742", None,
  {"outage_id": "OUT-2026-09-07-0031", "utility": "electricity", "cause": "fault",
   "started_at": "2026-09-07T13:58:44.000Z",
   "provenance": {"producer": "utility-telemetry/1.0.0", "node": "core-mcr-01",
                  "observed_at": "2026-09-07T13:58:47.000Z"}},
  {"outage_id": "OUT-2026-09-07-0031", "utility": "electricity", "cause": "fault",
   "asset_ref": {"class": "substation", "id": "SS-MCR-0742", "tenant": "mcr"},
   "affected_cells": ["MCR-0742-19", "MCR-0742-20", "MCR-0743-01"],
...
E("telemetry", "consumption-aggregated", "analytical", False, False,
  ...
  "substation", "SS-MCR-0742", None,
  {"geo": {"cell": "MCR-0742-19"}, "utility": "electricity",
   "aggregate": {"aggregate_id": "cons-MCR-0742-19-elec", "window": "2026-09-07T13Z", "revision": 0},
   "total": 918.4, "unit": "kWh", "meter_count": 214,
   "provenance": {"producer": "utility-telemetry/1.0.0", "node": "core-mcr-01",
                  "observed_at": "2026-09-07T14:01:00.000Z"}},
  {"geo": {"cell": "MCR-0742-19"}, "utility": "electricity",
   "asset_ref": {"class": "substation", "id": "SS-MCR-0742", "tenant": "mcr"},
   "aggregate": {"aggregate_id": "cons-MCR-0742-19-elec", "window": "2026-09-07T13Z", "revision": 1},
   "total": 918.4, "unit": "kWh", "meter_count": 214,
   "provenance": {"producer": "utility-telemetry/1.0.0", "node": "core-mcr-01",
...
E("transit", "vehicle-position-reported", "operational", False, False,
  ...
  {"asset_ref": {"class": "vehicle", "id": "BUS-4471", "tenant": "mcr"},
   "geo": {"lat": 53.6112, "lon": -2.1503},
   "provenance": {"producer": "transit-core/1.0.0", "node": "site-mcr-depot-01",
                  "observed_at": "2026-09-07T14:02:00.000Z"}},
  {"asset_ref": {"class": "vehicle", "id": "BUS-4471", "tenant": "mcr"},
   "route_id": "R-142", "trip_id": "T-142-0743",
   "geo": {"lat": 53.6112, "lon": -2.1503, "accuracy_m": 6.0, "cell": "MCR-0742-19"},
...
E("transit", "stop-arrived", "operational", False, False,
  ...
  {"asset_ref": {"class": "vehicle", "id": "BUS-4471", "tenant": "mcr"},
   "stop_ref": {"class": "stop", "id": "S-00912", "tenant": "mcr"},
...
E("transit", "load-estimated", "operational", False, True,
  ...
  {"asset_ref": {"class": "vehicle", "id": "BUS-4471", "tenant": "mcr"},
   "trip_id": "T-142-0743", "stop_ref": {"class": "stop", "id": "S-00912", "tenant": "mcr"},
...
E("transit", "headway-deviated", "operational", False, False,
  ...
  {"route_id": "R-142", "stop_ref": {"class": "stop", "id": "S-00912", "tenant": "mcr"},
   "direction": "bunching", "scheduled_headway_s": 600, "actual_headway_s": 95,
   "provenance": {"producer": "transit-core/1.0.0", "node": "core-mcr-01",
...
E("transit", "od-flow-aggregated", "analytical", False, False,
  ...
  "gateway", "GW-MCR-TRANSIT-01", None,
  {"origin_cell": "MCR-0742-19", "destination_cell": "MCR-0755-04",
   "aggregate": {"aggregate_id": "od-MCR-0742-19-MCR-0755-04", "window": "2026-09-07T08Z", "revision": 0},
   "journeys": 428,
   "provenance": {"producer": "transit-core/1.0.0", "node": "core-mcr-01",
...
E("transit", "journey-completed", "operational", True, True,
  ...
  {"subject_ref": {"pid": pid("transit", 3, "traveller-a"), "epoch": 3},
   ...
   "origin_stop": {"class": "stop", "id": "S-00912", "tenant": "mcr"},
   "destination_stop": {"class": "stop", "id": "S-01044", "tenant": "mcr"},
...
E("vision", "stream-health-changed", "operational", False, False,
  ...
  {"asset_ref": {"class": "camera", "id": "CAM-0742-03", "tenant": "mcr"},
   "stream_id": "cam-mcr-0742-03", "state_to": "degraded",
   "changed_at": "2026-09-07T14:00:41.000Z",
   "provenance": {"producer": "mca-ingest/1.0.0", "node": "site-mcr-north-02",
                  "observed_at": "2026-09-07T14:00:41.180Z"}},
  {"asset_ref": {"class": "camera", "id": "CAM-0742-03", "tenant": "mcr"},
   "stream_id": "cam-mcr-0742-03", "state_from": "healthy", "state_to": "degraded",
...
E("vision", "object-detected", "operational", False, True,
  ...
  "camera", "CAM-0742-03", "asset:camera:CAM-0742-03",
  {"asset_ref": {"class": "camera", "id": "CAM-0742-03", "tenant": "mcr"},
   "track_ref": {"stream_id": "cam-mcr-0742-03", "track_id": "9f2c1a7be4d05836",
  ...
  {"asset_ref": {"class": "camera", "id": "CAM-0742-03", "tenant": "mcr"},
   "track_ref": {"stream_id": "cam-mcr-0742-03", "track_id": "9f2c1a7be4d05836",
                 "window": "2026-09-07T14Z"},
   "bbox": {"x": 0.412, "y": 0.318, "w": 0.061, "h": 0.174},
   "geo": {"lat": 53.6099, "lon": -2.1559, "accuracy_m": 3.2, "cell": "MCR-0742-19"},
   "detected_at": "2026-09-07T14:02:09.000Z",
   "provenance": {"producer": "mca-ingest/1.0.0", "node": "site-mcr-north-02",
                  "observed_at": "2026-09-07T14:02:09.044Z", "confidence": 0.96,
...
E("vision", "footage-retention-applied", "audit", False, False,
  ...
  "camera", "CAM-0742-03", "asset:camera:CAM-0742-03",
  {"asset_ref": {"class": "camera", "id": "CAM-0742-03", "tenant": "mcr"},
   "stream_id": "cam-mcr-0742-03", "policy_id": "P-STD-31D", "action": "purged",
...
E("vision", "footage-sealed", "evidential", False, False,
  ...
  "camera", "CAM-0742-03", "asset:camera:CAM-0742-03",
  {"asset_ref": {"class": "camera", "id": "CAM-0742-03", "tenant": "mcr"},
   "stream_id": "cam-mcr-0742-03", "seal_id": "SEAL-2026-0044",
   "window_start": "2026-09-07T13:50:00.000Z", "window_end": "2026-09-07T14:20:00.000Z",
   "legal_basis_ref": "court-order/MCR-CC-2026-1187", "sealed_at": "2026-09-07T16:02:00.000Z",
   "provenance": {"producer": "mca-ingest/1.0.0", "node": "core-mcr-01",
  ...
  {"asset_ref": {"class": "camera", "id": "CAM-0742-03", "tenant": "mcr"},
   ...
   "track_ref": {"stream_id": "cam-mcr-0742-03", "track_id": "9f2c1a7be4d05836",
                 "window": "2026-09-07T14Z"},
   "window_start": "2026-09-07T13:50:00.000Z", "window_end": "2026-09-07T14:20:00.000Z",
   "legal_basis_ref": "court-order/MCR-CC-2026-1187", "hold_until": "2027-09-07T00:00:00.000Z",
   "digest": {"alg": "sha-256",
...
E("vision", "count-aggregated", "analytical", False, False,
  ...
  {"geo": {"cell": "MCR-0742-19"}, "object_class": "person", "count": 1842,
   "aggregate": {"aggregate_id": "cnt-MCR-0742-19-person", "window": "2026-09-07T14Z", "revision": 0},
   "provenance": {"producer": "mca-ingest/1.0.0", "node": "core-mcr-01",
...
E("identity", "pseudonym-issuance-recorded", "audit", False, False,
  ...
  "gateway", "GW-MCR-ID-01", "asset:gateway:GW-MCR-ID-01",
  {"domain": "transit", "epoch": 3, "count": 1842,
   "aggregate": {"aggregate_id": "psi-transit-e3", "window": "2026-07-01T00Z", "revision": 0},
   "provenance": {"producer": "identity-gateway/1.0.0", "node": "core-mcr-id-01",
...
E("identity", "pseudonym-epoch-rotated", "audit", False, False,
  ...
  "gateway", "GW-MCR-ID-01", "asset:gateway:GW-MCR-ID-01",
  {"rotation_id": "ROT-2026-Q3-transit", "tenant": "mcr", "domain": "transit",
...
E("identity", "correlation-performed", "audit", False, False,
  ...
  {"correlation_id": "COR-2026-09-07-0007", "domain_a": "transit", "domain_b": "identity",
   "purpose_code": "SAFEGUARDING", "principal_a": "dpo.mcr.gov", "principal_b": "head-of-transit.mcr.gov",
   "legal_basis_ref": "court-order/MCR-CC-2026-1187", "expires_at": "2026-09-14T00:00:00.000Z",
...
E("identity", "erasure-attested", "audit", False, False,
  ...
  {"erasure_id": "ERA-2026-09-07-0021", "outcome": "completed",
   "attested_at": "2026-09-07T09:14:23.000Z", "principal": "kms.mcr.gov",
   "provenance": {"producer": "identity-gateway/1.0.0", "node": "core-mcr-id-01",
...
E("identity", "oauth-client-registered", "audit", False, False,
  ...
  {"client_id": "transit-account-web", "sector": "transit-resident", "client_type": "public",
   ...
   "principal": "platform.mcr.gov", "registered_at": "2026-05-14T09:20:00.000Z",
   "provenance": {"producer": "identity-gateway/1.0.0", "node": "core-mcr-id-01",
                  "observed_at": "2026-05-14T09:20:00.310Z"}},
  {"client_id": "transit-account-web", "sector": "transit-resident", "client_type": "public",
   "grant_types": ["authorization-code", "refresh-token"], "token_endpoint_auth_method": "none",
   "redirect_uris": ["https://account.transit.mcr.gov/callback", "http://127.0.0.1:7890/callback"],
   "principal": "platform.mcr.gov", "registered_at": "2026-05-14T09:20:00.000Z",
   "provenance": {"producer": "identity-gateway/1.0.0", "node": "core-mcr-id-01",
...
E("identity", "oauth-client-updated", "audit", False, False,
  ...
  {"client_id": "transit-account-web", "changed_fields": ["redirect_uris"],
   "principal": "platform.mcr.gov", "updated_at": "2026-08-01T11:04:00.000Z",
   "provenance": {"producer": "identity-gateway/1.0.0", "node": "core-mcr-id-01",
...
E("identity", "oauth-client-revoked", "audit", False, False,
  ...
  {"client_id": "depot-terminal-legacy", "reason": "superseded",
   "principal": "platform.mcr.gov", "revoked_at": "2026-09-01T00:00:00.000Z",
   "provenance": {"producer": "identity-gateway/1.0.0", "node": "core-mcr-id-01",
...
def envelope(ev, kind, data):
    ...
    e["specversion"] = "1.0"
    e["id"] = ulid(seed)
    e["source"] = "//blume.systems/mcr/%s/%s/%s" % (ev["domain"], ev["src_class"], ev["src_id"])
